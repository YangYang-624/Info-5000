...
DEFAULT_RUN_ID = "stage-three-run-v1"
...
PUBLIC_ANCHOR_ALIASES = {
    ...
    "stage_two": "UA4_EVTBO_3.00C_rest10m_4.30C_v4p16",
}
FOLLOWUP_ANCHOR_PROTOCOLS = {
    "UA4_VTBO_3.00C_rest10m_4.25C_tail2.40C": {
        "name": "UA4_VTBO_3.00C_rest10m_4.25C_tail2.40C",
        "description": "Public stage-one winner used to seed the later staged search line.",
    ...
    "UA4_EVTBO_3.00C_rest10m_4.30C_v4p16": {
        ...
        "description": "Public stage-two winner used as the anchor for the stage-three search.",
        ...
        "parameters": {
            "source_run_id": "stage-two-reference-v1",
            "source_summary": "experiments/runs/stage_two/results/stage_two_summary.json",
...
def public_protocol_label(protocol_name: str | None) -> str | None:
    ...
    if protocol_name.startswith("UA4_EVTBO_"):
        return "stage_two"
    if protocol_name.startswith("UA5_PSMS_"):
        return "stage_three"
...
def combined_stress_v1_scenarios() -> List[Scenario]:
    return [
        Scenario("nominal", "No parameter perturbation", {}),
        Scenario(
            "hot_plating_combo",
...
def build_scenarios(scenario_set: str) -> List[Scenario]:
    ...
    if scenario_set in {"heldout_combo_v1", "combined_stress_v1"}:
        return combined_stress_v1_scenarios()
...
def run_search(
    *,
    ...
    output_dir = quest_root / "experiments" / "runs" / "stage_three" / "results"
